    ...
    <body class="portal-body">
        <div class="portal-container">
            ...
            <div class="search-container">
                <input type="text" id="searchInput" class="search-input" placeholder="Search" onkeyup="searchItems()">
            </div>
            ...
            <footer class="portal-footer">
                <p>Want to submit a report? <a href="login.php" class="login-link">Log in.</a></p>
            </footer>
        </div>
    </body>
</html>
